...
def main(root, typ, loops=10):
    ...
    for i in range(loops):
        ...
        ret = 0
        if typ==0:
            ret = test_type0(execMain(f'{root}/main.js', dat), exp)
        elif typ==1:
            ret = test_type1(execMain(f'{root}/main.js', dat), exp)
        elif typ==2:
            ret = test_type2(execMain(f'{root}/main.js', dat), exp)
        elif typ==3:
            ret = test_type3(execMain(f'{root}/main.js', dat), exp)
        else:
